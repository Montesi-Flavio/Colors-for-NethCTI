...
new Vue({
  ...
  data: {
    ...
    methods: {
        ...
        getColor: function(){
            a = localStorage.getItem('awesomeColors')
            b = a.split(",");
            this.color0 = 'linear-gradient(to right,' + a + ')'; 
            console.log("colorObj", b);
            this.color = b[0];
            this.color1 = b[1];
            this.color2 = b[2];
        },
        ...
        setColor: function (colorObj) { 
            ...
            this.color0 = 'linear-gradient(to right,' + colorObj + ')';

            this.color = colorObj[0];
            this.color1 = colorObj[1];
            this.color2 = colorObj[2];
