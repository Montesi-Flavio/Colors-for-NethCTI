var app = angular.module("app", []);
        ...
        app.controller("controller", 
            ...
            $scope.color0 = "linear-gradient(to right,#9400D3,#4B0082)";
            ...
            $scope.getColor = function(){
                ...
                if(localStorage)
                $scope.a = localStorage.getItem('awesomeColors');
                $scope.b = $scope.a.split(",");
                $scope.color0 = 'linear-gradient(to right,' + $scope.b + ')'; 
                console.log("get", $scope.color0)
            }
            (window.getColor)
            ...
            $scope.resetLocalStorage = function(){
                console.log("non fa");
                $scope.color0 = "";
                localStorage.setItem('awesomeColors', null);
            }

            $scope.setColor = function(colorObj){
                
                localStorage.setItem('awesomeColors', colorObj);
                $scope.color0 = 'linear-gradient(to right,' + colorObj + ')';
                console.log("color", $scope.color0);
            }
